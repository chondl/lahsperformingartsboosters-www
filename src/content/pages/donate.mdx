...
campaign, separate from the Back-to-School campaign** on this page. MBCG donations pay for
the parts of the season that nothing else covers: marching band and color guard
instructional staff, the mid-season band camp, the trip to the WBA Class Championships,
the show t-shirt every student receives, and meals at rehearsals, games, and competitions.
...
<CTAButton href="/donate-mbcg" label="Give to the MBCG campaign" />

Everything above about ways to give — check, donor-advised fund, employer matching — applies
to MBCG gifts too. More about the season and the program is on the
[Marching Band & Color Guard page](/programs/mbcg/).
